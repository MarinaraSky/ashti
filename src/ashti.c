    ...
    char **argv)
{
    ...
    if (setsockopt
        (fd, SOL_SOCKET, SO_REUSEADDR | SO_REUSEPORT, &opt, sizeof(opt)) != 0)
    {
    ...
    uint64_t * fileType)
{
    ...
    case (0):                  /* OK */
    {
        ...
        {
            asprintf(&retString, httpBanner, 200, "OK", date, "text/css",
                     size);
            *fileType = 0;
        }
        else if (strcmp(fExt, ".txt") == 0)
        {
            asprintf(&retString, httpBanner, 200, "OK", date, "text/plain",
                     size);
            *fileType = 0;
        }
        else if (strcmp(fExt, ".jpeg") == 0)
        {
            asprintf(&retString, httpBanner, 200, "OK", date, "image/jpeg",
                     size);
            *fileType = 1;
        }
        else if (strcmp(fExt, ".ico") == 0)
        {
            asprintf(&retString, httpBanner, 200, "OK", date,
                     "image/vnd.microsoft.icon", size);
            *fileType = 0;
        }
        else if (strcmp(fExt, ".png") == 0)
        {
            asprintf(&retString, httpBanner, 200, "OK", date, "image/png",
                     size);
            *fileType = 1;
        }
        else if (strcmp(fExt, ".gif") == 0)
        {
            asprintf(&retString, httpBanner, 200, "OK", date, "image/gif",
                     size);
            *fileType = 1;
        }
        else if (strcmp(fExt, ".html") == 0)
        {
            asprintf(&retString, httpBanner, 200, "OK", date, "text/html",
                     size);
            *fileType = 0;
        }
        else
    ...
    case (1):                  /* 400 */
    {
        char            err400[] =
            ...
            "<h2>Error 400</h2>\n" "</body>\n" "</html>\n";
        asprintf(&retString, httpBanner, 400, "Bad Request", date, "text/html",
                 strlen(err400));
    ...
    case (2):                  /* 404 */
    {
        char            err404[] =
            ...
            "<h2>Error 404</h2>\n" "</body>\n" "</html>\n";
        asprintf(&retString, httpBanner, 404, "Not Found", date, "text/html",
                 strlen(err404));
    ...
    case (3):                  /* 500 */
    {
        char            err500[] =
            ...
            "<h2>Error 500</h2>\n" "</body>\n" "</html>\n";
        asprintf(&retString, httpBanner, 500, "Internal Server Error", date,
                 "text/html", strlen(err500));
